        ...
        <div className="flex items-center justify-between rounded-full border border-blue-800 bg-blue-950/80 px-6 py-3 backdrop-blur-md shadow-2xl">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              className="hidden md:flex items-center gap-2 bg-white px-5 py-2 rounded-full text-sm font-bold text-slate-950 hover:bg-blue-50 transition-transform active:scale-95 shadow-lg"
            >
