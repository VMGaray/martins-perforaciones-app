...
import { MessageSquare } from "lucide-react"; // Importamos el icono cuadrado

export default function WhatsAppButton() {
  // Configuración del link
  // REEMPLAZA ESTE NÚMERO POR EL TUYO REAL
  ...
  return (
    ...
    >
      {/* Icono más técnico y sobrio */}
      <MessageSquare size={20} className="text-blue-400 group-hover:text-white transition-colors" />
      
      {/* Texto que lo hace ver como un botón de soporte profesional */}
      <span className="text-xs font-bold uppercase tracking-[0.1em]">
        Consultar Ahora
      </span>

      {/* Efecto sutil de brillo en el borde */}
